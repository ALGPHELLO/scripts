...
source /home/algphello/android_shell_tools/android_bash.rc
bashsync
if [ "${REPOSYNC}" == "yes" ]
then
...
wget https://raw.githubusercontent.com/algphello/local_manifests/master/${DEVICE}.xml
if [ ! -f "${DEVICE}.xml" ]
then
exit 1
fi
...
export USE_CCACHE=1
export CCACHE_DIR="/home/algphello/.ccache-${DEVICE}"
ccache -M 25
