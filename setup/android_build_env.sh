...
sudo apt-get purge -y openjdk-11-jre openjdk-11-jdk
sudo apt-get install -y python gnupg flex bison gperf libsdl1.2-dev squashfs-tools build-essential zip unzip libncurses5-dev zlib1g-dev openjdk-8-jre openjdk-8-jdk \
